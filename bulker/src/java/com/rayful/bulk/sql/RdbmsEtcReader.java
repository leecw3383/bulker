 ...
 * @author webeng
 */
abstract public class RdbmsEtcReader 
{
	/** logger 지정 */
	protected static Logger logger = RayfulLogger.getLogger( RdbmsEtcReader.class.getName(), Config.LOG_PATH );
	
	/** 데이터소스 커넥션 */
	protected Connection mo_sourceConnection = null;
	
	/** Etc Query */
	protected Map<String, String> map_EtcQuery = null;

	public RdbmsEtcReader() {}
	/**
	 * 생성자
	 * @param oConnection	데이터소스 커넥션
	 */
	public RdbmsEtcReader( Connection oConnection, Map<String, String> mapEtcQuery ) {
