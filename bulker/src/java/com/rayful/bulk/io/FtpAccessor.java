/**
 *******************************************************************
 * 파일명 : FtpAccessor.java
 * 파일설명 : FTP를 통해 외부첨부파일을 가져오는 클래스를 정의
 *******************************************************************
 * 작성일자     작성자    내용
 * -----------------------------------------------------------------
 * 2005/05/16   정충열    최초작성             
...
/**
 * FTP를 통해 외부첨부파일을 가져오는 클래스 <p>
 * FilesAccessor를 상속해서 정의된 클래스
*/
public class FtpAccessor extends FilesAccessor
{
	String ms_hostName;			// 호스트명
	String ms_portNumber;		// 포트번호
	String ms_basePath;			// basepath 경로
	String ms_account;			// 계정
	String ms_password;			// 패스워드
	...
	/**
		...
		* @param	sAccount 계정 
		* @param	sPassword 패스워드
	*/
	public FtpAccessor ( String sHostName, 
										String sPortNumber, 
										String sBasePath, 
										String sAccount, 
										String sPassword )
	...
	*/	
	private String getURL()
	{
		...
		if ( ms_account != null && ms_password !=null ) {
			osb.append( ms_account );
			osb.append( ":");
			osb.append( ms_password );
			osb.append( "@");
		}
	...
	*/		
	...
	{
		StringBuffer osb = new StringBuffer("ClassName:FtpAccessor {\r\n");
